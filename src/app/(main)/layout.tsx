...
const allNavItems: NavItem[] = [
  ...
  { label: "Budgets", href: "/budgets", icon: <HiOutlineCurrencyDollar size={20} /> },
  { label: "Goals", href: "/goals", icon: <HiOutlineTrophy size={20} /> },
  { label: "Recurring", href: "/recurring-rules", icon: <HiOutlineArrowPath size={20} /> },
  { label: "Organizations", href: "/organizations", icon: <HiOutlineBuildingOffice2 size={20} /> },
